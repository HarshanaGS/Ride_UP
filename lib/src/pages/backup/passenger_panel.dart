...
class _PanelpassengerState extends State<Panelpassenger> {
      ...
      try {
        ...
        if (listaEnderecos.isNotEmpty) {
          ...
          if (placemarks.isNotEmpty) {
            ...
            CustomSnackbar.show(context, 'Unable to retrieve address details.');
          }
        }
      } catch (e, stackTrace) {
  ...
  Future<void> _salvarRequisicao(Destiny destination) async {
  ...
  void _statusUberfinished() async {
    ...
    double distanciaKM = distanciaEmMetros / 1000; // Corrected: convert meters to kilometers
